...
function BurgerMenu({ onLocationSearch, onCurrentLocation }) {
    return (
        ...
        <div class={style.dropdowncontent}>
            ...
            <button class={style.locationsearch} onClick={() => { navigator.geolocation.getCurrentPosition((position) => { position.coords.latitude; position.coords.longitude; onCurrentLocation(position.coords.latitude, position.coords.longitude); }); }}>Get Current Location</button>
        </div>
    )
}
